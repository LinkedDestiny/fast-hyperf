 ...
 * @property int enable
 */
class BasePgModel extends Model
{
     ...
     * @return bool
     */
    public static function insertOrUpdate(array $keys, array $values, array $value): bool
    {
        $query = static::buildQuery();
        ...
        // 构造查询语句
        $query = sprintf('%s ON CONFLICT (%s)  DO UPDATE SET  %s', $insert, implode(',', $keys), $update);
        // 组装sql绑定参数
